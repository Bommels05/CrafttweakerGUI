...
public class PurifyingRecipeType extends SupportedRecipeType<BasicPurifyingRecipe> {
    ...
    public PurifyingRecipeType() {
        super(CraftTweakerGUI.rl(MekanismAPI.MEKANISM_MODID, "purifying"));
    ...
    public BasicPurifyingRecipe onInitialize(@Nullable BasicPurifyingRecipe recipe) throws UnsupportedRecipeException {
        ...
        if (recipe == null) {
            return new BasicPurifyingRecipe(IngredientCreatorAccess.item().from(UNSET),
    ...
    public Object getEmiRecipe(BasicPurifyingRecipe recipe) throws UnsupportedViewerException {
        return new ItemStackChemicalToItemStackEmiRecipe((MekanismEmiRecipeCategory) getEmiCategory(CraftTweakerGUI.rl(MekanismAPI.MEKANISM_MODID, "purifying")), new RecipeHolder<>(nullRl(), recipe));
    }
