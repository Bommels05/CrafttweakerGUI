...
public class CrushingRecipeType extends SupportedRecipeType<BasicCrushingRecipe> {
    ...
    public CrushingRecipeType() {
        super(CraftTweakerGUI.rl(MekanismAPI.MEKANISM_MODID, "crushing"));
    ...
    public Object getEmiRecipe(BasicCrushingRecipe recipe) throws UnsupportedViewerException {
        return new ItemStackToItemStackEmiRecipe((MekanismEmiRecipeCategory) getEmiCategory(CraftTweakerGUI.rl(MekanismAPI.MEKANISM_MODID, "crushing")), new RecipeHolder<>(nullRl(), recipe));
    }
