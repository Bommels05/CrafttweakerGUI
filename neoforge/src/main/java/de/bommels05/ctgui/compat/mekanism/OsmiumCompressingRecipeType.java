...
public class OsmiumCompressingRecipeType extends SupportedRecipeType<BasicCompressingRecipe> {
    ...
    public OsmiumCompressingRecipeType() {
        super(CraftTweakerGUI.rl(MekanismAPI.MEKANISM_MODID, "compressing"));
    ...
    public Object getEmiRecipe(BasicCompressingRecipe recipe) throws UnsupportedViewerException {
        return new ItemStackChemicalToItemStackEmiRecipe((MekanismEmiRecipeCategory) getEmiCategory(CraftTweakerGUI.rl(MekanismAPI.MEKANISM_MODID, "compressing")), new RecipeHolder<>(nullRl(), recipe));
    }
