...
public class ScreenUtils {
    public static final ResourceLocation EDIT_BUTTON_TEXTURE = new ResourceLocation(CraftTweakerGUI.MOD_ID, "textures/gui/edit_button.png");
    public static final ResourceLocation EDIT_ICON_TEXTURE = new ResourceLocation(CraftTweakerGUI.MOD_ID, "textures/gui/edit_icon.png");
